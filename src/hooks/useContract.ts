...
import sushiLP from 'config/abi/sushi_lp.json'
...
export const useSushiLP = (address: string) => {
  const sushiAbi = sushiLP as unknown as AbiItem
  return useContract(sushiAbi, address)
}
